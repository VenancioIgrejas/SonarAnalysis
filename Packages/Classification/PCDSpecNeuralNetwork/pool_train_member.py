...
parser.add_argument("--n_members", default=24,type=int, help="number of Specialist for train")
...
def f_spec_train(params):
    ...
    p = subprocess.call(["python", "train_member_spec.py",
                         "-n",str(n_neurons),
                         "-i","10",
                         "-f","10",
                         "-b","512",
                         "--member-specialist",str(member),
                         "--dev",str(False),
                         "--ifold",str(ifold)])
