...
bdc = BDControl(main_path=results_path, columns=info_net.keys(), bd_file='bd_iris.csv')
...
sp = SpecialistClassification(mlp, classes_name,dir=folder,verbose=args.verbose,integrator='wta', class_weight=args.weight)
