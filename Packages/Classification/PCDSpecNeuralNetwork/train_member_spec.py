...
parser.add_argument("--member-specialist",default=0,type=int,help= "choose which specialist will be train")
...
if args.dev:
	results_path_specific = results_path + '/dev' + '/PCD_Spec_24class_' + trparamns.get_params_str()
else:
	results_path_specific = results_path + '/PCD_Spec_24class_' + trparamns.get_params_str()
...
telegram_send.send(messages=["O seu treinamento Especialista com PCDS (apenas um membro) com os seguintes parametros acabou de terminar!",
                             "FOLD: "+str(args.ifold),
                             "MEMBER: "+str(args.member_specialist),
                             "PCD: "+str(args.pcd),
